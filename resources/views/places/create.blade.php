    ...
    <form action="{{ route('place.store') }}" class="card" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group mt-2">
                ...
                <textarea name="description" id="" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi tempat kuliner">{{ old('description') }}</textarea>
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Masukkan no telepon tempat kuliner" value="{{ old('phone') }}">
            ...
            <div class="form-group mt-2">
               <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       ...
                       <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" placeholder="Masukkan no telepon tempat kuliner" value="{{ old('latitude') }}" readonly>
                   ...
                   <div class="col-md-6 col-sm-12">
                       ...
                       <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" placeholder="Masukkan no telepon tempat kuliner" value="{{ old('longitude') }}" readonly>
